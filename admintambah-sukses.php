                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="admintambah.html"><i class="menu-icon icon-plus-sign"></i>Tambah Data Alumni</a></li>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
                                    <div class="alert alert-success">
                                        ...
                                        <strong>Berhasil!</strong> Data baru telah disimpan :). <a href="adminlihat.html">Klik di sini untk melihat daftar alumni</a>
                                    </div>
                                    <form class="form-horizontal row-fluid">
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Username</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput" placeholder="Username untuk login" class="span6">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="basicinput" placeholder="Nama lengkap" class="span8">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="basicinput" placeholder="Kabupaten, Provinsi" class="span6">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Tanggal Lahir</label>
                                            <div class="controls">
                                                <input type="date" id="basicinput" class="span4">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a type="button" class="btn btn-success btn-large" href="admintambah-sukses.html">Ya. Simpan Data Baru</a>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <h5>
                                                Apakah anda yakin ingin membatalkan aksi saat ini dan meninggalkan halaman ini?
                                                </h5>
                                              </div>
                                              <div class="modal-footer">
