<?php
    $page="alumnitampilalumni";
    include("session.php");
    include("db.php");
    $id = $_SESSION['userid'];
    $u = mysqli_query($conn, "SELECT * FROM user, alumni WHERE alumni.user_iduser=".$id." AND alumni.user_iduser=user.iduser");
                                ...
                                <div class="module-body">
                                    ...
                                    <center>
                                        <div style="margin-top:15px;">
                                            <a class="btn btn-warning btn-large" href="alumnisuntingalumni.php">Ubah</a>
                                        </div>
                                    </center>
                                </div>
                            </div>
